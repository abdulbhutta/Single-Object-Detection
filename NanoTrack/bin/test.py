...
parser.add_argument('--config', default='./models/config/configv1.yaml',  type=str,help='config file')

parser.add_argument('--snapshot', default='models/pretrained/nanotrackv1.pth', type=str,help='snapshot of models to eval')
...
def main(): 
    ...
    #model_path = os.path.join(args.save_path, args.dataset, args.tracker_name)
    #.\results, GOT-10k, nanotrackv1.pth GOT-10k  lr-0.4  pk-0.1  win-0.4
    #C:\Users\LenovoPC\Desktop\SiamTrackers-master\NanoTrack\results

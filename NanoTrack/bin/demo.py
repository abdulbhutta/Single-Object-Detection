...
parser.add_argument('--snapshot', default='models/pretrained/nanotrackv1.pth', type=str, help='model name')
    ...
    for frame in get_frames(args.video_name):
        ...
        if first_frame: 
            ...
            if args.save: 
                ...
                save_video_path = './bin/_tracking2.mp4'
                print("save_video_path: ", save_video_path)
                fourcc = cv2.VideoWriter_fourcc(*'mp4v')
